...
| `uor.sign` | *(v0.2 placeholder)* Sign arbitrary content with an Ed25519 identity key |
...
| `UOR_SIGNING` | `disabled` | Enable the `uor.sign` tool placeholder (v0.2) |
| `GITHUB_TOKEN` | — | *Experimental*: persist passports to a GitHub repo |
| `UOR_GITHUB_OWNER`, `UOR_GITHUB_REPO` | — | *Experimental*: repo target for the above |
