...
impl UorTools {
    ...
    async fn verify_passport(
        ...
        // Enforce the `algorithm` field when present. The field was cosmetic in
        // v0.1.x; in v0.2.x it is load-bearing — an unknown algorithm returns
        // invalid_params rather than being silently ignored.
